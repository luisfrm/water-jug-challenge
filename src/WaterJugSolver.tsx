...
const WaterJugSolver: React.FC = () => {
  ...
  const handleSolve = () => {
    ...
    result ? setSolution(result) : setError('No existe solución');
  };
      ...
      <div className="input-group">
        <label>
          ...
          <input
            type="number"
            value={x}
            onChange={(e) => setX(validateInput(e.target.value))}
            min="1"
          />
        </label>
        ...
        <label>
          ...
          <input
            type="number"
            value={y}
            onChange={(e) => setY(validateInput(e.target.value))}
            min="1"
          />
        </label>
        ...
        <label>
          ...
          <input
            type="number"
            value={z}
            onChange={(e) => setZ(validateInput(e.target.value))}
            min="1"
          />
        </label>
      </div>
